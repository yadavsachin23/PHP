...
<body>
  ...
  <div class="container">
    ...
    <div class="alert alert-success" role="alert">
      ...
      <p>Hey <?php echo $_SESSION['username'] ?>! How are you Doing Today? Welcome to iConnect.</p>
      <hr>
      <p class="mb-0">Whenever you need to, be logout click on <a href="logout.php"><button class="btn btn-danger">Logout</button></a></p>
    </div>
